...
const transitions: Record<JobState, JobState[]> = {
  ...
  LAYERABILITY_GATE: ["DIRECTION_DISCOVERY", "DIRECTION_READY", "BUILDING", "HUMAN_INPUT_REQUIRED", "BLOCKED"],
  ...
  HUMAN_INPUT_REQUIRED: ["INTAKE", "SCENE_TOPOLOGY_AUDIT", "SOURCE_RESOLUTION", "LAYERABILITY_GATE", "DIRECTION_DISCOVERY", "BUILDING", "BLOCKED"],
