...
const transitions: Record<JobState, JobState[]> = {
  ...
  LAYERABILITY_GATE: ["DIRECTION_DISCOVERY", "DIRECTION_READY", "HUMAN_INPUT_REQUIRED", "BLOCKED"],
  DIRECTION_DISCOVERY: ["DIRECTION_READY", "HUMAN_INPUT_REQUIRED", "BLOCKED"],
  DIRECTION_READY: ["TEMPLATE_RESOLUTION", "BLOCKED"],
  TEMPLATE_RESOLUTION: ["MOTION_SPEC_READY", "BUILDING", "HUMAN_INPUT_REQUIRED", "BLOCKED"],
  MOTION_SPEC_READY: ["BUILDING", "HUMAN_INPUT_REQUIRED", "BLOCKED"],
